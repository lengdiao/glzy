...
//                response.append('\r');
    ...
    public static void main(String[] args) throws Exception {
        URL url = new URL("http://yxm.ipharmacare.org/guide/detail");
        String aa = sendPostXml(url,"application/x-www-form-urlencoded","23Q902QKG7huQUBphL1NJhUlQiUaJN1NJhCtOugyj+1NJheDTkkeJK1NJrcoOyUsug1NJhUm7Eo");
        System.out.println("ResultData:"+aa);
    }
